...
import 'package:nectar/view/login/phone_view.dart' as _i4;
...
/// generated route for
/// [_i4.PhoneView]
class PhoneRoute extends _i5.PageRouteInfo<void> {
  const PhoneRoute({List<_i5.PageRouteInfo>? children})
      : super(
          PhoneRoute.name,
          initialChildren: children,
        );
